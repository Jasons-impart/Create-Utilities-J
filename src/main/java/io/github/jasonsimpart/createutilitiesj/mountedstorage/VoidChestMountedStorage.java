...
import io.github.jasonsimpart.createutilitiesj.blocks.voidtypes.chest.VoidChestInventory;
...
public class VoidChestMountedStorage extends WrapperMountedItemStorage<VoidChestInventory> {
    ...
    private VoidChestMountedStorage(VoidMotorNetworkHandler.NetworkKey key) {
        this(CreateUtilitiesJ.VOID_CHEST_INVENTORIES_DATA.computeStorageIfAbsent(key));
    }
