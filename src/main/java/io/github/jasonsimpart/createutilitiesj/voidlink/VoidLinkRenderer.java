package io.github.jasonsimpart.createutilitiesj.voidlink;
...
public class VoidLinkRenderer {
	...
	public static void tick() {
		...
		Component player = Component.translatable(CreateUtilitiesJ.ID + ".logistics.owner");
		...
		for (int index : VoidLinkHandler.arr012) {
			...
			if (index < 2) {
				...
				tip.add(label.copy());
				tip.add(Component.translatable(CreateUtilitiesJ.ID +
